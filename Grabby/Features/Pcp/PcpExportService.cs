...
using Grabby.Common;
using Grabby.Features.Packaging;

namespace Grabby.Features.Pcp;
                ...
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(templateJson))
                    {
                        ...
                        if (templateObj["Author"] == null)
                            templateObj["Author"] = "Grabby Export";
                        if (templateObj["Description"] == null)
                            templateObj["Description"] = "Template exported from Grabby";
