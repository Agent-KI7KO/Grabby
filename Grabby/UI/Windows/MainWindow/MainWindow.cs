...
using Grabby.Features.Mcdf;
using Grabby.Features.Pcp;
using Grabby.Features.Pmp;
using Grabby.Features.Pmp.ChangedItems;
using Grabby.Services;
using Grabby.Services.SnapshotManager;
...
public partial class MainWindow : Window, IDisposable
{
    ...
    private readonly Grabby _grabby;
    ...
    public MainWindow(Grabby grabby, IActorService actorService, IActiveSnapshotManager activeSnapshotManager,
        ...
        )
    {
        ...
        TitleBarButtons.Add(
            new TitleBarButton
            {
                ...
                Click = _ => _grabby.DrawConfigUI(),
                ShowTooltip = () => ImGui.SetTooltip("Grabby Settings")
            }
        );

        _grabby.SnapshotsUpdated += OnSnapshotsChanged;
        _grabby.GPoseService.GPoseExited += ClearActorSelection;
    }
    ...
    public override void Draw()
    {
        ...
        ImGui.Separator();
        MainWindowBottomBar.Draw(_grabby, _activeSnapshotManager);
    }
