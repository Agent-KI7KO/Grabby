...
public partial class MainWindow
{
    ...
    private bool _isActorLockedByGrabby;
    ...
    private void UpdateSelectedActorState()
    {
        ...
        else
        {
            ...
            var allowOutside = _grabby.Configuration.AllowOutsideGpose;
            var allowOwnedPets = allowOutside && _grabby.Configuration.AllowOutsideGposeOwnedPets;
            var isOwnedPet = allowOwnedPets && ActorOwnershipUtil.IsSelfOwnedPet(actor);
            _isActorModifiable =
                _grabby.Configuration.DisableAutomaticRevert
        ...
        else
        {
            ...
            var includeTempActors = _grabby.Configuration.UseLiveSnapshotData
                                    && _grabby.Configuration.IncludeVisibleTempCollectionActors;
        ...
        // --- Update lock state ---
        _isActorLockedByGrabby = _activeSnapshotManager.IsActorLockedByGrabby(actor);
    }
    ...
    private (string Text, string Tooltip, bool IsDisabled) GetSnapshotButtonState()
    {
        ...
        {
            var restriction = _grabby.Configuration.UseLiveSnapshotData
                ? _grabby.Configuration.IncludeVisibleTempCollectionActors
    ...
    private (FontAwesomeIcon Icon, string Tooltip, bool IsDisabled) GetLockButtonState()
    {
        ...
        if (!_isActorLockedByGrabby) return (FontAwesomeIcon.Unlock, "This actor is not locked by Grabby.", true);
